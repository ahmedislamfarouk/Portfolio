  ...
  return (
    <PageWrapper>
      <main className="relative min-h-screen">
        ...
        <section id="projects">
          <ScrollReveal direction="up" distance={40} duration={1.2} start="top 90%">
            <Projects />
          </ScrollReveal>
        </section>

        {/* About — Split layout: stats + bio */}
        <section id="about">
          <About />
        </section>

        {/* Experience — Research Journey Timeline */}
        ...
        <div className="relative w-full h-px overflow-hidden">
          <div
            ...
            style={{
              background:
                'linear-gradient(90deg, transparent 0%, #06B6D4 25%, #7C3AED 50%, #2563EB 75%, transparent 100%)',
          ...
          <div className="max-w-[1400px] mx-auto w-full px-6 md:px-12 lg:px-20 relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="text-center md:text-left">
                <div className="text-sm font-black uppercase tracking-wider text-white mb-1">
                  Ahmed Badr
                </div>
